...
@section('title', 'Tambah Kelompok Keahlian')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Tambah Kelompok Keahlian</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('super-admin-kk-add') }}" method="post">
                            @csrf
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('short_name') is-invalid @enderror" id="short_name"
                                    name="short_name" value="{{ old('short_name') }}" maxlength="10" required>
                                @error('short_name')
