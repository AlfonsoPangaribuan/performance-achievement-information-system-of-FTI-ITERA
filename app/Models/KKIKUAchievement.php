...
class KKIKUAchievement extends Model
{
    ...
    */
    ...
    protected $table = 'kk_iku_achievements';
    ...
    */
    ...
    {
        return $this->hasMany(KKIKUAchievementData::class);
    }

    public function evaluation(): HasMany
    {
        return $this->hasMany(KKIKUEvaluation::class);
    }
}